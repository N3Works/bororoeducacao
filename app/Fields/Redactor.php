    ...
    public function build()
    {
        ...
        switch ($this->status) {
            ...
            case "modify":
                ...
                Rapyd::js('tinymce_4/tinymce.min.js');
//                Rapyd::js('tinymce/tinymce_editor.js');
                ...
                Rapyd::script("tinymce.init({selector: '#" . $this->name . "', file_browser_callback : elFinderBrowser, plugins: 
                            [ 'advlist autolink lists link image charmap print preview anchor',
    'searchreplace visualblocks code fullscreen',
    'insertdatetime media table contextmenu paste code'], convert_urls: false});"
                );

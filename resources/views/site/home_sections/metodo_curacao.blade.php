  ...
  <!-- sub-text -->
    <div class="center-block-4 col-md-12 col-sm-12 col-xs-12 centered" style="text-align:justify">
            ...
            <p class="margin-top15 text-large" style="text-align:center">
                ...
                <p  class="text-large" >
                  O Método Curação é uma caixinha de ferramentas de <a href="http://escoladecuracao.com.br/blog/68" style="color:blue">alfabetização emocional</a> para que você
                  assuma o protagonismo de sua vida de forma saudável. <a href="http://www.escoladecuracao.com.br/loja/"  style="color:blue">Saiba mais</a> no Libreto 3, da Série A Arte de Se
                  Fazer Feliz.
               </p>
        </p>
        ...
        {{-- <div class="center-block-3">
            ...
            <!-- Main Heading -->
            <h2 class="margin-top20 font-comfortaa text-main-1">
                <span>Método CurAção</span> da Bororó25
            </h2>
            <!-- subtext -->
            <p class="subtext font-asap text-white">
                Uma tecnologia para autoconhecimento
            </p>
            <!-- portfolio button -->

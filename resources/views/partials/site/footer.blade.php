<!-- Footer Style 4 -->
<footer class="footer-4" style="background-image: url({{url('/images/barra_laranja.png')}}) ;
    ...
    <div class="row all-links">
      ...
      <div class="col-md-3 col-sm-6 col-xs-8">
        <div class="social-wide transition">
          ...
          <a href="https://www.youtube.com/channel/UCmc0QwrntPMSspO2q3BEiTw" target="_blank"><span class="ti-youtube"></span>Youtube</a>
        </div>
      </div>
      <!-- About info -->
      <div class="col-md-3 col-sm-6 col-xs-8">

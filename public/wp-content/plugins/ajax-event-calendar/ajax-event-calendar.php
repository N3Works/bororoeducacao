	...
	class ajax_event_calendar {
		...
		if (version_compare($current, '1.0.1', '<')) {
			...
			if ($plugin_updated) {
				...
				$_POST['event']['linkCalendar'] = AEC_HOMEPAGE;
	    ...
	    function localize_plugin($page) {
			...
			// register scripts
			wp_register_script('fullcalendar', AEC_URL . 'js/jquery.fullcalendar.min.js', false, '1.5.3', true);
			wp_register_script('simplemodal', AEC_URL . 'js/jquery.simplemodal.1.4.3.min.js', false, '1.4.3', true);
			...
			wp_register_script('timepicker', AEC_URL . 'js/jquery.timePicker.min.js', false, '5195', true);
			wp_register_script('growl', AEC_URL . 'js/jquery.jgrowl.min.js', false, '1.2.5', true);
			wp_register_script('miniColors', AEC_URL . 'js/jquery.miniColors.min.js', false, '0.1', true);
			wp_register_script('jeditable', AEC_URL . 'js/jquery.jeditable.min.js', false, '1.7.1', true);
			wp_register_script('mousewheel', AEC_URL . 'js/jquery.mousewheel.min.js', false, '3.0.6', true);
			wp_register_script('init_admin_calendar', AEC_URL . 'js/jquery.init_admin_calendar.js', false, AEC_VERSION, true);
			wp_register_script('init_show_calendar', AEC_URL . 'js/jquery.init_show_calendar.js', false, AEC_VERSION, true);
			wp_register_script('init_show_category', AEC_URL . '/js/jquery.init_admin_category.js', false, AEC_VERSION, true);

...
<?php if ( have_comments() ) : ?>
	...
	<h3><?php comments_number(get_option('phi_trans_noresponses'),get_option('phi_trans_oneresponses'), '% '.get_option('phi_trans_responses')  );?> <?php echo get_option('phi_trans_to');?> &#8220;<?php the_title(); ?>&#8221;</h3>

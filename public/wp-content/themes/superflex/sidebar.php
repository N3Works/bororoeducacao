...
<div class="sidebar sidebar-<?php echo $sidebarposition;?>">
					...
					<?php $selectsidebar = get_post_meta($post->ID,'phi_selectsidebar',true);
					
					if(is_home() || is_page_template('blog.php') || is_archive() || is_category() || is_search() || is_tag()){if (function_exists('dynamic_sidebar') && dynamic_sidebar('Blog Sidebar')){};}

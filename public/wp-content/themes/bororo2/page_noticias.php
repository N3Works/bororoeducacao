...
<?php $page = (get_query_var('paged')) ? get_query_var('paged') : 1; query_posts('cat=1,3,7'); while ( have_posts() ) : the_post() ?>

			<div class="post" id="post-<?php the_ID(); ?>">

		
			<div class="entry">
<div style="font-size:16px; padding-top:15px;"><?php the_time(__('m/d/Y', 'kubrick')) ?> - <a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>"><?php the_title(); ?></a></div><?php the_excerpt(); ?> 

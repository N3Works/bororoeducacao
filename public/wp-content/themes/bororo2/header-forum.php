...
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/style_forum.css" type="text/css" media="screen" />
...
<div id="midheader">
<div class="rightimg"><img src="<?php bloginfo('template_directory'); ?>/images/topo.jpg" width="994" height="126" /></div>
</div>

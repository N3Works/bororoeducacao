...
function accordion_item($atts, $content = null) {
	...
	return "<h4><span class='icon'><span class='control-pm'></span></span><span class='text'>".$caption."</span></h4><div class='accordion_content'><div class='accordion_content_inner'>" . no_wpautop($content) . "</div></div>";
}
}
